...
---@class kenjutsu.LogResult
---@field lines string[] Display lines for the buffer (1-indexed)
---@field highlights table<integer, kenjutsu.HighlightSpan[]> Maps line number to highlight spans
---@field commits_by_line table<integer, kenjutsu.Commit> Maps line number to commit data (commit lines only)
...
local function get_hl_group(fg, bg, bold)
  ...
  local name = "KenjutsuAnsi_" .. key:gsub("[#:]", "_")
  local def = {}
  if fg then
    def.fg = fg
  end
...
---@return kenjutsu.HighlightSpan[] highlights list of highlight spans
...
---@param callback fun(err: string|nil, result: kenjutsu.LogResult|nil)
...
---@param callback fun(err: string|nil, metadata: kenjutsu.CommitMetadata|nil)
...
---@param dir string
---@param opts kenjutsu.SquashOpts
---@param callback fun(err: string|nil)
...
---@class kenjutsu.JjTreeEntry
---@field path string file path
---@field status "modified"| "added"| "removed"| "copied"| "renamed"

---@param dir string
---@param change_id string
---@param callback fun(err: string|nil, files: kenjutsu.JjTreeEntry[]|nil)
