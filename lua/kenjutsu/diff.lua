...
local mod_comments = require("kenjutsu.comments")
...
---@alias kenjutsu.DiffMode "remaining" | "reviewed" | "all"

local tree_labels = { base = "Old", marker = "Reviewed", target = "New" }

---@param mode kenjutsu.DiffMode
...
local function diff_buf_name(commit_id, file_path, tree)
  return "kenjutsu://" .. commit_id .. "/" .. file_path .. ":" .. tree
end

---@param dir string
---@param commit_id string
---@param file_path string
---@param cb fun(comments: kenjutsu.PortedComment[])
...
---@class kenjutsu.DiffState.SideInfo
...
function DiffState:current_side()
  ...
  ---@type kenjutsu.DiffState.SideInfo
  return {
    side = side,
...
---@param callbacks kenjutsu.DiffCallbacks
...
---@class kenjutsu.SetFileOpts
---@field line integer|nil
---@field side "Old"|"New"|nil

---@param file kenjutsu.FileEntry
---@param jump_opts kenjutsu.SetFileOpts|nil
...
function DiffState:open_all_comments()
  local comment_picker = require("kenjutsu.comment_picker")
  comment_picker.open({
    dir = self.dir,
    commit_id = self.commit_id,
