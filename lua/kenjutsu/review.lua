...
local diff = require("kenjutsu.diff")
local file_list = require("kenjutsu.file_list")
local utils = require("kenjutsu.utils")

local M = {}

---@class kenjutsu.ReviewState
---@field dir string
---@field commit_id string
---@field files kenjutsu.FileEntry[]
---@field line_map table<integer, kenjutsu.FileEntry>
---@field file_list_bufnr integer
---@field file_list_winnr integer
---@field diff_state kenjutsu.DiffState  persistent diff pane state
...
---@class kenjutsu.ReviewStateInitOpts
---@field dir string
---@field commit_id string
---@field file_list_bufnr integer
---@field file_list_winnr integer
---@field diff_state kenjutsu.DiffState
---@field log_bufnr integer
---@field on_close function

---@param opts kenjutsu.ReviewStateInitOpts
---@return kenjutsu.ReviewState
function ReviewState.new(opts)
  --- @type kenjutsu.ReviewState
  local fields = {
    dir = opts.dir,
...
function M.open(dir, commit_id, log_bufnr, on_close)
  local file_list_bufnr = create_scratch_buf("kenjutsu-review-files")
