---@alias kenjutsu.TreeKind "base" | "marker" | "target"
...
local function get_kjn_bin()
  if not kjn_bin then
    local path = require("kenjutsu.install").bin_path()
    if path == nil then
      error(
        "kjn binary not found. Install with :lua require('kenjutsu.install').download() or build from source with: cargo build --release --bin kjn"
      )
    end
    kjn_bin = path
  end
...
---@class kenjutsu.Daemon
---@field job_id integer
---@field next_id integer
---@field pending table<integer, fun(err: string|nil, result: table|nil)>
---@field buf string

---@type table<string, kenjutsu.Daemon>
local daemons = {}

---@param dir string
---@return kenjutsu.Daemon
...
---@class kenjutsu.FetchBlobOptions
---@field commit_id string
---@field file_path string
---@field old_path string|nil
---@field tree_kind kenjutsu.TreeKind
---@field dir string

---@param opts kenjutsu.FetchBlobOptions
...
---@class kenjutsu.FilesResult
---@field files kenjutsu.FileEntry[]
---@field commitId string
---@field changeId string

---@class kenjutsu.FileEntry
...
---@class kenjutsu.FetchFilesOptions
---@field commit_id string
---@field find_latest_commit boolean?

---@param dir string
---@param opts kenjutsu.FetchFilesOptions
---@param cb fun(err: string|nil, result: kenjutsu.FilesResult|nil)
function M.files(dir, opts, cb)
  send_request(dir, "files", opts, cb)
end

---@class kenjutsu.SetBlobOptions
---@field dir string
---@field commit_id string
---@field file_path string

---@param opts kenjutsu.SetBlobOptions
...
---@class kenjutsu.MarkFileOptions
---@field dir string
---@field commit_id string
---@field file_path string
---@field old_path string|nil

---@param opts kenjutsu.MarkFileOptions
---@param cb fun(err: string|nil, result: table|nil)
...
---@class kenjutsu.PortedComment
---@field comment kenjutsu.MaterializedComment
---@field ported_line integer|nil
---@field ported_start_line integer|nil
---@field is_ported boolean

---@class kenjutsu.MaterializedComment
---@field id string
...
---@field replies kenjutsu.MaterializedReply[]

---@class kenjutsu.MaterializedReply
---@field id string
---@field body string
---@field created_at string
---@field updated_at string
...
---@class kenjutsu.FileComments
---@field file_path string
---@field comments kenjutsu.PortedComment[]

---@class kenjutsu.GetCommentsResult
---@field files kenjutsu.FileComments[]

---@param dir string
---@param commit_id string
---@param cb fun(err: string|nil, result: kenjutsu.GetCommentsResult|nil)
...
---@class kenjutsu.AddCommentOptions
---@field dir string
---@field commit_id string
---@field file_path string
---@field side "Old"|"New"
...
---@param opts kenjutsu.AddCommentOptions
---@param cb fun(err: string|nil, result: table|nil)
...
---@class kenjutsu.ReplyToCommentOptions
---@field dir string
---@field commit_id string
---@field file_path string
...
---@param opts kenjutsu.ReplyToCommentOptions
---@param cb fun(err: string|nil, result: table|nil)
...
---@class kenjutsu.EditCommentOptions
---@field dir string
---@field commit_id string
---@field file_path string
...
---@param opts kenjutsu.EditCommentOptions
---@param cb fun(err: string|nil, result: table|nil)
...
---@class kenjutsu.ResolveCommentOptions
---@field dir string
---@field commit_id string
---@field file_path string
---@field comment_id string

---@param opts kenjutsu.ResolveCommentOptions
---@param cb fun(err: string|nil, result: table|nil)
