...
local FileTreeState = require("kenjutsu.file_tree").FileTreeState

local M = {}

local ns = vim.api.nvim_create_namespace("kenjutsu_log")
local squash_ns = vim.api.nvim_create_namespace("kenjutsu_squash")

vim.api.nvim_set_hl(0, "KenjutsuSquashSource", { default = true, link = "CursorLine" })

local describe_buf_counter = 0

---@class kenjutsu.SquashState
---@field source kenjutsu.Commit
---@field source_line integer
---@field paths string[]|nil

---@class kenjutsu.LogScreenState
---@field commits_by_line table<integer, kenjutsu.Commit>
---@field commit_lines integer[]
---@field dir string
---@field file_tree kenjutsu.FileTreeState|nil
---@field bufnr integer
---@field winnr integer
---@field squash_state kenjutsu.SquashState|nil
...
function LogScreenState.new()
  ...
  vim.bo[bufnr].filetype = "kenjutsu-log"
...
---@class kenjutsu.LogScreen.CommitAtCursorOptions
...
---@param opts kenjutsu.LogScreen.CommitAtCursorOptions | nil
---@return kenjutsu.Commit|nil
...
---@param result kenjutsu.LogResult
...
---@param metadata kenjutsu.CommitMetadata
---@return string
...
function LogScreenState:open_squash_file_picker()
  ...
  jj.list_files(self.dir, commit.change_id, function(err, files)
    ...
    local squash_files = require("kenjutsu.squash_files")
...
function LogScreenState:setup_keymaps()
  ...
  vim.keymap.set("n", "<CR>", function()
    ...
    if commit then
      ...
      require("kenjutsu.review").open(self.dir, commit.commit_id, bufnr, on_close_review)
    end
  end, opts)
...
---@return kenjutsu.LogScreenState
function M.open()
  vim.cmd("tabnew")
